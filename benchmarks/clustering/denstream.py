"""DenstreamDBSCAN on all StreamArena clustering datasets (prequential evaluation).
...
def make_learner(schema, seed):
    from capymoa.clusterers import Denstream_with_dbscan

    return Denstream_with_dbscan(schema=schema)


if __name__ == "__main__":
    run(
        task="clustering",
        algorithm="DenstreamDBSCAN",
